...
class Index extends Action
{
     ...
     * @var string
     */
    public const META_DESCRIPTION_CONFIG_PATH = 'sample/something_else/meta_description';
    /**
     * @var string
     */
    public const META_KEYWORDS_CONFIG_PATH = 'sample/something_else/meta_keywords';
    /**
     * @var string
     */
    public const META_TITLE_CONFIG_PATH = 'sample/something_else/meta_title';
    /**
     * @var string
     */
    const BREADCRUMBS_CONFIG_PATH = 'sample/something_else/breadcrumbs';
    /**
